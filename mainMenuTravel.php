	...
	<body>		
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<a href="travelDetail.php"><button type="button" class="btn btn-default mainMenu">Travel Detail</button></a>
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="col-md-4">
					<a href="approvement.php"><button type="button" class="btn btn-default mainMenu" >Approvement</button></a>
				</div>
				<div class="col-md-4"></div>
			</div>
		</div>
